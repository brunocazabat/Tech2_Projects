...
nts::P4017::P4017(std::string const& val)
{
  (void)val;
}

nts::P4017::~P4017(void) {}

nts::Tristate nts::P4017::Compute(size_t pute)
{
...
void nts::P4017::Setlien(size_t pute__num__this,
...
void nts::P4017::Dump(void) const
{
...
nts::Tristate nts::P4017::compute__nand(nts::Tristate lhs, nts::Tristate rhs) const
{
...
nts::Tristate nts::P4017::computeInput(size_t pute) const
{
  if (__pute[pute - 1])
    {
...
nts::Tristate nts::P4017::computeOutput(size_t pute) const
{
...
nts::Tristate nts::P4017::computeVDD(size_t pute) const
{
  (void)pute;
...
nts::Tristate nts::P4017::computeVSS(size_t pute) const
{
  (void)pute;
