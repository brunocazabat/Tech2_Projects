...
nts::P4040::P4040(std::string const& val)
{
  (void)val;
}

nts::P4040::~P4040(void) {}

nts::Tristate nts::P4040::Compute(size_t pute)
{
...
void nts::P4040::Setlien(size_t pute__num__this,
...
void nts::P4040::Dump(void) const
{
...
nts::Tristate nts::P4040::compute__nand(nts::Tristate lhs, nts::Tristate rhs) const
{
...
nts::Tristate nts::P4040::computeInput(size_t pute) const
{
  if (__pute[pute - 1])
    {
...
nts::Tristate nts::P4040::computeOutput(size_t pute) const
{
...
nts::Tristate nts::P4040::computeVDD(size_t pute) const
{
  (void)pute;
...
nts::Tristate nts::P4040::computeVSS(size_t pute) const
{
  (void)pute;
