...
nts::Tristate nts::True::Compute(size_t pute_num_this)
{
...
void nts::True::Setlien(size_t pute_num_this,
...
nts::Tristate nts::True::getval(void) const
{
  return (__val);
}

void nts::True::setval(std::string const& val)
{
  if (val == "0")
...
{
  std::cout << "Input TRUE - val: " << static_cast<int>(__val) << std::endl;
